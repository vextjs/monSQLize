...
const { createSafeDeleteOps } = require('./safe-delete');  // 🆕 v1.2.0: safeDelete 扩展方法
const { createUpdateOrInsertOps } = require('./update-or-insert');  // 🆕 v1.2.0: updateOrInsert 扩展方法
const { createBulkUpsertOps } = require('./bulk-upsert');  // 🆕 v1.2.0: bulkUpsert 扩展方法
