...
|---------|------|---------|---------|
| [v2.0.0](./changelogs/v2.0.0.md) | 2026-05-19 | 🎉 **v2.0.0 — TypeScript rewrite**: full TypeScript source, cache-hub integration, MultiLevel cache support, v1 API compat preserved, JSDoc coverage complete, `getPoolStats/getPoolHealth` keyed by pool name, v1 compat fixes included | [View](./changelogs/v2.0.0.md) |
