...
> **Version**: v1.1.0+
> **Type**: Unified Expression System
> **Category**: Query and Aggregation
...
- [String functions (12)](#string-functions-12)
- [CONCAT - String concatenation](#concat-string-concatenation)
- [UPPER - Convert to uppercase](#upper-convert-to-uppercase)
...
- [LTRIM - Remove left spaces](#ltrim-remove-left-spaces)
- [RTRIM - remove spaces on the right](#rtrim-remove-spaces-on-the-right)
- [SUBSTR - substring extraction](#substr-substring-extraction)
- [SUBSTR_CP - Substring extraction (Unicode)](#substr-cp-substring-extraction-unicode)
- [LENGTH - String length](#length-string-length)
- [SPLIT - String splitting](#split-string-splitting)
- [REPLACE - string replacement](#replace-string-replacement)
- [INDEX_OF_STR - String search](#index-of-str-string-search)
- [Math functions (6)](#math-functions-6)
- [ABS - Absolute value](#abs-absolute-value)
- [CEIL - Round up](#ceil-round-up)
- [FLOOR - round down](#floor-round-down)
- [ROUND - round up](#round-round-up)
- [SQRT - square root](#sqrt-square-root)
- [POW - Exponentiation](#pow-exponentiation)
- [Array functions (10)](#array-functions-10)
- [SIZE - array size](#size-array-size)
- [FIRST - the first element of the array](#first-the-first-element-of-the-array)
- [LAST - the last element of the array](#last-the-last-element-of-the-array)
- [SLICE - array slice](#slice-array-slice)
- [ARRAY_ELEM_AT - Get array elements](#array-elem-at-get-array-elements)
- [IN - Array contains check](#in-array-contains-check)
- [FILTER - Array filtering](#filter-array-filtering)
- [MAP - Array mapping](#map-array-mapping)
- [INDEX_OF - array search](#index-of-array-search)
- [CONCAT_ARRAYS - Array concatenation](#concat-arrays-array-concatenation)
- [Aggregation functions (7)](#aggregation-functions-7)
- [SUM - Sum](#sum-sum)
- [AVG - Average](#avg-average)
- [MAX - Maximum value](#max-maximum-value)
- [MIN - Minimum value](#min-minimum-value)
- [COUNT - count](#count-count)
- [PUSH - Build an array](#push-build-an-array)
- [ADD_TO_SET - Construct a unique array](#add-to-set-construct-a-unique-array)
- [Date functions (6)](#date-functions-6)
- [YEAR - Get the year](#year-get-the-year)
- [MONTH - Get the month](#month-get-the-month)
- [DAY_OF_MONTH - Get the date](#day-of-month-get-the-date)
- [HOUR - Get the hour](#hour-get-the-hour)
- [MINUTE - Get minutes](#minute-get-minutes)
- [SECOND - Get seconds](#second-get-seconds)
- [DATE_ADD - Date addition 🆕 v1.1.0](#date-add-date-addition-v110)
- [DATE_SUBTRACT - Date subtraction 🆕 v1.1.0](#date-subtract-date-subtraction-v110)
- [DATE_DIFF - Date difference calculation 🆕 v1.1.0](#date-diff-date-difference-calculation-v110)
- [DATE_TO_STRING - Date formatting 🆕 v1.1.0](#date-to-string-date-formatting-v110)
- [DATE_FROM_STRING - String parsing 🆕 v1.1.0](#date-from-string-string-parsing-v110)
- [Types and logical functions (5)](#types-and-logical-functions-5)
- [TYPE - Get the type](#type-get-the-type)
- [NOT - logical negation](#not-logical-negation)
- [EXISTS - Existence check](#exists-existence-check)
- [IS_NUMBER - Numeric type check](#is-number-numeric-type-check)
- [IS_ARRAY - Array type check](#is-array-array-type-check)
- [Advanced operation functions (7)](#advanced-operation-functions-7)
- [REGEX - regular matching](#regex-regular-matching)
- [MERGE_OBJECTS - Merge objects](#merge-objects-merge-objects)
- [TO_INT - Convert to integer](#to-int-convert-to-integer)
- [TO_STRING - Convert to string](#to-string-convert-to-string)
- [OBJECT_TO_ARRAY - object to array](#object-to-array-object-to-array)
- [ARRAY_TO_OBJECT - Array to object](#array-to-object-array-to-object)
- [SET_UNION - Set union](#set-union-set-union)
- [Conditional function (1)](#conditional-function-1)
- [SWITCH - Multi-condition judgment](#switch-multi-condition-judgment)
- [Function index table](#function-index-table)
- [Usage example](#usage-example)
- [Example 1: User classification](#example-1-user-classification)
- [Example 2: Calculate discount price](#example-2-calculate-discount-price)
- [Example 3: Data aggregation](#example-3-data-aggregation)
- [Example 4: Array processing](#example-4-array-processing)
- [Example 5: String processing](#example-5-string-processing)
- [Performance recommendations](#performance-recommendations)
- [1. Use index](#1-use-index)
- [2. Avoid complex nesting](#2-avoid-complex-nesting)
- [3. Use cache](#3-use-cache)
- [4. Reasonable use of $match](#4-reasonable-use-of-match)
