...
- [getCache()](#getcache)
  ...
  - [Cache instance method](#cache-instance-method)
- [Usage example](#usage-example)
- [Basic usage](#basic-usage)
  - [1. Get cache instance](#1-get-cache-instance)
  - [2. View cache statistics](#2-view-cache-statistics)
  - [3. Manual cache operation](#3-manual-cache-operation)
  - [4. Clear all caches](#4-clear-all-caches)
- [getDefaults()](#getdefaults)
  - [Method signature (getDefaults())](#method-signature-getdefaults)
  - [Parameter description (getDefaults())](#parameter-description-getdefaults)
  - [Return value (getDefaults())](#return-value-getdefaults)
  - [5. Get the cache information of a specific collection (recommended method ⭐)](#5-get-the-cache-information-of-a-specific-collection-recommended-method)
  - [6. Get the cache of a specific operation](#6-get-the-cache-of-a-specific-operation)
  - [7. Analyze cache usage (simplified method ⭐)](#7-analyze-cache-usage-simplified-method)
  - [8. Complete cache management tool function](#8-complete-cache-management-tool-function)
- [getDefaults() example](#getdefaults-example)
- [1. View the default configuration](#1-view-the-default-configuration)
- [2. Verify that the configuration takes effect](#2-verify-that-the-configuration-takes-effect)
- [3. Debugging configuration issues](#3-debugging-configuration-issues)
- [4. Runtime configuration comparison](#4-runtime-configuration-comparison)
- [getNamespace()](#getnamespace)
  - [Method signature (getNamespace())](#method-signature-getnamespace)
  - [Parameter description (getNamespace())](#parameter-description-getnamespace)
  - [Return value (getNamespace())](#return-value-getnamespace)
- [getNamespace() example](#getnamespace-example)
- [1. Get the namespace](#1-get-the-namespace)
- [2. Multiple collection namespaces](#2-multiple-collection-namespaces)
- [3. Application of namespace in logs](#3-application-of-namespace-in-logs)
- [4. Namespace verification](#4-namespace-verification)
- [5. Namespace when operating across databases](#5-namespace-when-operating-across-databases)
- [Best Practices](#best-practices)
- [1. Cache monitoring](#1-cache-monitoring)
- [1.1 Monitor the cache of a specific collection (using getNamespace ⭐)](#11-monitor-the-cache-of-a-specific-collection-using-getnamespace)
- [2. Configuration verification](#2-configuration-verification)
- [3. Namespace tracking](#3-namespace-tracking)
- [4. Cache warm-up](#4-cache-warm-up)
- [FAQ](#faq)
- [Q1: What should I do if `getCache()` returns `null`?](#q1-what-should-i-do-if-getcache-returns-null)
- [Q2: How to view the cache key of a query?](#q2-how-to-view-the-cache-key-of-a-query)
- [Q3: How to clear the cache of a specific collection?](#q3-how-to-clear-the-cache-of-a-specific-collection)
- [Q4: Can the configuration of `getDefaults()` be modified?](#q4-can-the-configuration-of-getdefaults-be-modified)
- [Q5: What are the practical uses of `getNamespace()`?](#q5-what-are-the-practical-uses-of-getnamespace)
- [Q6: How to check how many caches a specific collection has? (Recommended method ⭐)](#q6-how-to-check-how-many-caches-a-specific-collection-has-recommended-method)
- [Q7: How to clear the cache of an operation for a specific collection?](#q7-how-to-clear-the-cache-of-an-operation-for-a-specific-collection)
