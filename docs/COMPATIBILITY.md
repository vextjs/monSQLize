...
|-------------|---------|---------|------|
| **14.x** | ✅ 支持 | ✅ 已测试 | 最低支持版本（>=14.0.0） |
| **16.x** | ✅ 支持 | ✅ 已测试 | LTS，支持 Worker Threads |
...
| Promise.allSettled | 12.9+ | ✅ 条件支持（自动检测） |
| 可选链 (?.) | 14.0+ | ✅ 全版本支持 |
| 空值合并 (??) | 14.0+ | ✅ 全版本支持 |
...
- 📖 文档: [docs/](./INDEX.md)
- 💬 讨论: [GitHub Discussions](https://github.com/vextjs/monSQLize/discussions)
- 🐛 Bug Report: [GitHub Issues](https://github.com/vextjs/monSQLize/issues)
