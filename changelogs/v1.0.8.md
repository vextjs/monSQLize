...
| **发布日期** | 2026-01-16 |
| **版本号** | v1.0.8 |
| **主要变更** | 企业级多连接池 + Update 聚合管道（已实现） + Saga 事务（已规划） |
...
- [需求方案](../plans/requirements/req-saga-transaction-v1.0.8.md) - 详细的需求分析
- [示例代码](../examples/saga-transaction.examples.js) - 6个实用示例
...
- [需求文档](../plans/requirements/req-multi-pool-v1.0.8.md)
