...
- 示例代码（历史路径: `../examples/sync-backup.examples.js`）
- 方案设计（历史路径: `../plans/requirements/req-sync-changestream-final-v1.0.9.md`）
- 验证报告（历史路径: `../reports/monSQLize/verification/sync-changestream-verification-v1.0.9.md`）
